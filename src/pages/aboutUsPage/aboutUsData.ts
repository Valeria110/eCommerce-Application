export const aboutUsData = [
  {
    ...
    contributions: [
      ...
      'Created pages for an application (login, user profile, about us pages)',
      'Writing tests with Jest',
      'Checking PRs and clear feedback',
      'Routing implementation and deploy',
    ],
    education: [
  ...
  },
  {
    ...
    contributions: [
      'Team organization',
      'Writing tests with Jest',
      'Created pages for an application (main, detailed product, basket pages)',
      'Development environment configuration and scripts ',
      ' Clear feedback to PRs',
    ],
    education: [
  ...
  },
  {
    name: 'vika',
    contributions: [
      'Added a detailed description of the project and the technology stack used',
      'Created pages for an application (registration, catalog pages)',
      'Enhanced detailed product and catalog pages',
