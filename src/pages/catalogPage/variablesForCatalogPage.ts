...
export const listItemAllBooks = createElement('li', 'dropdown-item list-categories__item d-none', 'All books');
...
export const listItemNoSort = createElement('li', 'dropdown-item list-sort__item d-none', 'No sort');
